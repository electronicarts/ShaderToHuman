...
void scene(inout Context3D context)
{
    ...
    s2h_drawArrowWS(context, vec3(0, 0, 0) + offset, vec3(0, 5, 0) + offset, vec4(1, 1, 1, 1), 1.0f);
    s2h_drawArrowWS(context, vec3(2, 0, 0) + offset, vec3(2, 3, 0) + offset, vec4(1, 1, 0, 1), 1.0f);
    s2h_drawArrowWS(context, vec3(0, 0, 2) + offset, vec3(0, 3, 2) + offset, vec4(0, 1, 1, 1), 1.0f);
