...
void scene(inout Context3D context)
{
    ...
    s2h_drawLineWS(context, vec3(-1, 2,  1) + offset, vec3(1, 2,  1) + offset, vec4(1, 1, 0, 1), 0.09f);
    s2h_drawLineWS(context, vec3(-1, 2, -1) + offset, vec3(1, 2, -1) + offset, vec4(1, 1, 0, 1), 0.09f);
    s2h_drawLineWS(context, vec3(-1, 2, -1) + offset, vec3(-1, 2, 1) + offset, vec4(1, 1, 0, 1), 0.09f);
    s2h_drawLineWS(context, vec3( 1, 2, -1) + offset, vec3( 1, 2, 1) + offset, vec4(1, 1, 0, 1), 0.09f);
    s2h_drawLineWS(context, vec3( 1, 0, -1) + offset, vec3( 1, 4, -1) + offset, vec4(1, 1, 1, 1), 0.5f);
